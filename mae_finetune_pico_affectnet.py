...
from engine_finetune_pico import train_one_epoch, evaluate
from models import models_vit_proto
...
def get_args_parser():
	...
	# append
	parser.add_argument('--dataset', default='affectnet7', type=str)
	parser.add_argument('--data_path', default='/dockerdata/small', type=str, help='dataset path')
	parser.add_argument('--output_dir', default='/xxxx/', type=str)
	parser.add_argument('--exp', default='default', type=str)
	parser.add_argument('--nb_classes', default=7, type=int,
	                    help='number of the classification types')
	parser.add_argument('--smoothing', type=float, default=0.1,
	                    help='Label smoothing (default: 0.1)')
	parser.add_argument('--labelset', default='/xxxx/', type=str)
	parser.add_argument('--start_update', default=0, type=int)
	#
...
class partial_loss_smooth(torch.nn.Module):
	def __init__(self, confidence, lb_smooth=0.1, conf_ema_m=0.99, num_classes=8):
		super().__init__()
...
def main(args):
	...
	model = models_vit_proto.__dict__[args.model](
	...
	criterion = partial_loss_smooth(confidence, lb_smooth=args.smoothing, num_classes=args.nb_classes)
	...
	for epoch in range(args.start_epoch, args.epochs):
		...
		one_epoch_best, confidence = train_one_epoch(
			...
			confidence=confidence, start_upd_prot=(epoch >= args.start_update)
		)
		criterion.set_conf_ema_m(epoch, args)
